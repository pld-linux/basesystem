...
Summary(ru):	Базовый пакет, определяющий систему PLD Linux
Summary(uk):	Базовий пакет, який визнача╓ систему PLD Linux
Name:		basesystem
Version:	1.0
Release:	10
Epoch:		2
...
функцию - определяет компоненты базовой системы PLD Linux, такие как
...
- визнача╓ компоненти базово╖ системи PLD Linux, так╕ як посл╕довн╕сть
